...
- If a tool's schema shows structured fields (e.g. \`to\`, \`subject\`, \`body\`), use those fields directly; do not pass \`instruction\` for that tool.
